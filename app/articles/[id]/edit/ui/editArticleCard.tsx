...
export default function EditArticleCard({
  description,
  thumbnail,
  published,
  tags,
  ...
  const [preview, setPreview] = useState<string>(
    thumbnail ? `${thumbnail}/public` : ""
  );
  const [isPublic, setIsPublic] = useState<boolean>(published);
